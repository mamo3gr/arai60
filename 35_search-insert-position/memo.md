...
いろいろ読んでみたが、いざ書いてみようと思うとまだ迷うな。  
はじめに区間の端点（初期値）を定義するが、思考の順番が違う気がする。

https://github.com/TORUS0818/leetcode/pull/44#discussion_r1997511549
...
書けたけど半分暗記している気もする。もう数日置いてまたやってみよう。
